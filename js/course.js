(function () {
  ...
  const decisionLabels = {
    underload: "Проанализировать прошлые периоды. Если отклонение разовое — использовать время на перерывы, подготовку к пику и чистоту; если повторяется — скорректировать количество часов на смене без ущерба следующей смене",
    overload: "Встать в зону наблюдения на 2–5 минут, определить западающую станцию и усилить её опытным сотрудником",
    quality: "Проанализировать конкретный отзыв, найти корневую причину недовольства, исправить её и проверить результат",
    stable: "Сохранить текущую расстановку и через час повторно проверить ITPH, скорость обслуживания и качество"
  };
