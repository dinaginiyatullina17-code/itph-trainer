(function () {
  ...
  const periodChoices = [
    ...
    [
      ...
      { value: "high-manager-station", text: "ITPH выше плана. Менеджеру занять самую загруженную станцию до конца пика, а команде сохранить текущую расстановку", feedback: "Помощь менеджера даст временный эффект, но не устранит причину. Сначала понаблюдай и скорректируй расстановку команды." },
